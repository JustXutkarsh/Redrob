...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json({ error: error instanceof Error ? error.message : "Opportunity radar failed", fallback: true, liveMode: "demo", opportunities: mockCareerTwin.opportunities }, { status: 200 });
  }
}
